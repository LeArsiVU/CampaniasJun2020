...
select CAST(FLOOR(idu_ClienteCodigoMaestro/10) as SIGNED) as idu_ClienteCodigo, des_CorreoElectronico, fec_FechaAltaCorreo
...
CAST(FLOOR(idu_ClienteCodigoMaestro/10) as SIGNED)  NOT BETWEEN 90000000 and 99999999;
